...
public class NeoForgePlayerConnectionListener {

    private final FPlayerService fPlayerService;
    private final EventDispatcher eventDispatcher;
    private final TaskScheduler taskScheduler;

    public void asyncProcessJoinEvent(ServerGamePacketListenerImpl handler) {
    ...
    public void asyncProcessQuitEvent(ServerGamePacketListenerImpl handler) {
        UUID uuid = handler.getPlayer().getUUID();
