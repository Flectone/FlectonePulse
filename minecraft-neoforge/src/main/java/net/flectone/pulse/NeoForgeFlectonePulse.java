...
import net.flectone.pulse.resolver.NeoForgeLibraryResolver;
...
public class NeoForgeFlectonePulse implements FlectonePulse {
    ...
    public void onLoad() {
        ...
        fLogger = new FLogger(new NeoForgeLogAdapter(logger), () -> fileFacade);
        fLogger.logEnabling();

        // set up library resolver for dependency loading
        libraryResolver = new NeoForgeLibraryResolver(fLogger);
