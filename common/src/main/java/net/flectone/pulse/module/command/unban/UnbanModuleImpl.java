...
public class UnbanModuleImpl implements UnbanModule {
    ...
    public void unban(FPlayer fPlayer, String target, int id, String reason) {
        ...
        if (!fileFacade.command().ban().filterByServer()) {
            proxySender.send(fTarget, ModuleName.UPDATE_CACHE_BAN, dataOutputStream -> dataOutputStream.writeUTF(gson.toJson(unban)));
        }
        ...
        EventMetadata.Builder baseMetadataBuilder = EventMetadata.builder()
                ...
                .proxy(dataOutputStream ->
                        dataOutputStream.writeUTF(gson.toJson(unban))
                )
