...
public abstract class ChatsettingModuleImpl implements ChatsettingModule {
    ...
    protected ChatsettingModuleImpl(FileFacade fileFacade,
    ...
    public Set<PermissionSetting> permissions() {
        Set<PermissionSetting> permissions = new LinkedHashSet<>(ChatsettingModule.super.permissions());
        permissions.add(permission().other());
        permissions.addAll(permission().settings().values());
