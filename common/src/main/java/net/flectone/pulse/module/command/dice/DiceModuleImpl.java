...
public class DiceModuleImpl implements DiceModule {
    ...
    public void execute(FPlayer fPlayer, CommandContext<FPlayer> commandContext) {
        ...
        messageDispatcher.dispatch(this, EventMetadata.builder()
                ...
                .proxy(dataOutputStream -> dataOutputStream.writeUTF(gson.toJson(cubes)))
                .integration(() -> IntegrationMessageFormat.builder()
                        .format(_ -> replaceResult(FPlayer.UNKNOWN, cubes))
                        .build()
                )
                .build()
        );
