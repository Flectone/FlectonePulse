...
public class UnmuteModuleImpl implements UnmuteModule {
    ...
    public void unmute(FPlayer fPlayer, String target, int id, String reason) {
        ...
        EventMetadata.Builder baseMetadataBuilder = EventMetadata.builder()
                ...
                .proxy(dataOutputStream ->
                        dataOutputStream.writeUTF(gson.toJson(unmute))
                )
                .integration(() -> IntegrationMessageFormat.builder()
                        .format(string -> moderationMessageFormatter.replacePlaceholders(string, FPlayer.UNKNOWN, unmute))
                        .build()
                );
