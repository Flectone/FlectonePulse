...
public class NamesModuleImpl implements NamesModule {
    ...
    public Set<PermissionSetting> permissions() {
        Set<PermissionSetting> permissions = new LinkedHashSet<>(NamesModule.super.permissions());
        permissions.add(permission().invisible());
