...
import net.flectone.pulse.checker.ValidNameChecker;
...
public class WhitelistModuleImpl implements WhitelistModule {
    ...
    public Set<PermissionSetting> permissions() {
        Set<PermissionSetting> permissions = new LinkedHashSet<>(WhitelistModule.super.permissions());
    ...
    private Optional<Moderation> turn(FPlayer fPlayer, @Nullable String reason, long time, boolean turned) {
        ...
        if (!config().filterByServer()) {
            proxySender.send(fTarget, ModuleName.UPDATE_CACHE_WHITELIST, dataOutputStream -> dataOutputStream.writeUTF(gson.toJson(moderation)));
        }
    ...
    private void actionAdd(FPlayer fPlayer, Pair<Long, String> timeReasonPair, String argument, @Nullable String existingName) {
        ...
        EventMetadata.Builder baseMetadataBuilder = EventMetadata.builder()
                ...
                .proxy(dataOutputStream -> {
                    ...
                    dataOutputStream.writeUTF(gson.toJson(whitelist));
                })
                .integration(() -> IntegrationMessageFormat.builder()
    ...
    private void actionRemove(FPlayer fPlayer, CommandContext<FPlayer> commandContext) {
        ...
        EventMetadata.Builder baseMetadataBuilder = EventMetadata.builder()
                ...
                .proxy(dataOutputStream -> {
                    ...
                    dataOutputStream.writeUTF(gson.toJson(unwhitelist));
                })
                .integration(() -> IntegrationMessageFormat.builder()
