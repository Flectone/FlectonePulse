...
@Singleton
public class WhitelistModerationParserImpl extends ModerationParserImpl implements WhitelistModerationParser {

    private final ModerationService moderationService;
    private final OfflinePlayerParser offlinePlayerParser;

    @Inject
    public WhitelistModerationParserImpl(ModerationService moderationService,
