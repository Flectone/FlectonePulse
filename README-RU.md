...
## 🌍 **Умная локализация — говорим на языке игрока!** 🗣️  
...
- ⌨️ **[CommandAPI](https://github.com/CommandAPI/CommandAPI)** — создавай команды с автодополнением, от которого плачут нейросети  
