...
| Модуль                                                                                                                                                                                                             | Описание                                                                               |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| [![MOTD](https://flectone.net/pulse/version.png)](https://flectone.net/pulse/docs/message/motd/)                                                                                                                   | Анимированный многострочный статус сервера с собственными текстурами                   |
...
| [![Belowname](https://flectone.net/pulse/belowname.png)](https://flectone.net/pulse/docs/message/nametag/)                                                                                                         | Настраиваемый текст под именем игрока                                                  |
...
| [![Sidebar](https://flectone.net/pulse/scoreboard.png)](https://flectone.net/pulse/docs/message/scoreboard/)                                                                                                       | Анимированный scoreboard в боковой панели                                              |
...
| [![Death](https://flectone.net/pulse/deathserver.png)](https://flectone.net/pulse/docs/message/death/) [![Advancement](https://flectone.net/pulse/task.png)](https://flectone.net/pulse/docs/message/advancement/) | Замена стандартных сообщений Minecraft на свои (сообщения о смерти, достижения и т.д.) |
