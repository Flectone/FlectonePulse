...
public final class FlectonePulseBungeecord extends Plugin implements Listener {
    ...
    private final BungeeLoginStateListener bungeeDisconnectListener = new BungeeLoginStateListener();
    ...
    public void onDisconnectEvent(PlayerDisconnectEvent event) {
        ...
        if (bungeeDisconnectListener.getLoginStatus(playerUUID) != BungeeLoginStateListener.LoginStatus.CONNECTED) return;
