...
@Singleton
public class BukkitMiniPlaceholdersModule implements ModuleSimple {

    private final FileFacade fileFacade;
    private final PaperMiniPlaceholdersIntegration miniPlaceholdersIntegration;
    private final ListenerRegistry listenerRegistry;
    private final ModuleController moduleController;

    @Inject
    public BukkitMiniPlaceholdersModule(FileFacade fileFacade,
        ...
        this.miniPlaceholdersIntegration = new PaperMiniPlaceholdersIntegration(
                fileFacade,
                fPlayerService,
