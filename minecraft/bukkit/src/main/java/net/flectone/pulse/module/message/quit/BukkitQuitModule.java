...
public class BukkitQuitModule extends MinecraftQuitModule {
    ...
    public BukkitQuitModule(FileFacade fileFacade,
        ...
        super(fileFacade, integrationModule, taskScheduler, messageDispatcher, moduleController, listenerRegistry, platformServerAdapter, eventDispatcher, proxyRegistry, fPlayerService);
