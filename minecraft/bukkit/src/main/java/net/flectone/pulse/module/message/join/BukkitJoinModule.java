...
public class BukkitJoinModule extends MinecraftJoinModule {
    ...
    public BukkitJoinModule(FileFacade fileFacade,
        ...
        super(fileFacade, platformPlayerAdapter, platformServerAdapter, integrationModule, listenerRegistry, taskScheduler, messageDispatcher, moduleController, playtimeService, proxyRegistry);
