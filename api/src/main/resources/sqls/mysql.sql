...
CREATE INDEX `idx_fp_player_name` ON `fp_player`(`name`);
CREATE INDEX `idx_fp_player_ip` ON `fp_player`(`ip`);
CREATE INDEX `idx_fp_player_online` ON `fp_player`(`online`);

CREATE INDEX `idx_fp_time_total` ON `fp_time`(`total` DESC);

CREATE INDEX `idx_fp_mail_receiver_valid` ON `fp_mail`(`receiver`, `valid`);
CREATE INDEX `idx_fp_mail_sender_valid` ON `fp_mail`(`sender`, `valid`);
