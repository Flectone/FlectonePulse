...
public class HytaleJoinModule extends JoinModule {
    ...
    public HytaleJoinModule(FileFacade fileFacade,
        ...
        super(fileFacade, platformPlayerAdapter, integrationModule, taskScheduler, messageDispatcher, moduleController, fPlayerService, eventDispatcher, proxyRegistry);
