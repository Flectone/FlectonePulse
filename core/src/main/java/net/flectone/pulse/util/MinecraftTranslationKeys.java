...
public enum MinecraftTranslationKeys {
    ...
    COMMANDS_ENCHANT_FAILED("commands.enchant.failed"),
    COMMANDS_ENCHANT_FAILED_ENTITY("commands.enchant.failed.entity"),
    COMMANDS_ENCHANT_FAILED_INCOMPATIBLE("commands.enchant.failed.incompatible"),
    COMMANDS_ENCHANT_FAILED_ITEMLESS("commands.enchant.failed.itemless"),
    COMMANDS_ENCHANT_FAILED_LEVEL("commands.enchant.failed.level"),
