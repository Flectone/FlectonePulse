...
public final class Localization extends FileSerializable implements IModule {
    ...
    @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/")})

    private String cooldown = "<color:#ff7171><b>⁉</b> Too fast, you'll be able to use it in <time>";

    private Time time = new Time();

    @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/")})
    private Command command = new Command();
    @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/integration/")})
    private Integration integration = new Integration();
    @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/")})
    ...
    public static final class Command implements IModule.ICommand, ILocalization {
        ...
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/ball/")})
        private Ball ball = new Ball();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/ban/")})
        private Ban ban = new Ban();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/banlist/")})
        private Banlist banlist = new Banlist();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/broadcast/")})
        private Broadcast broadcast = new Broadcast();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/chatcolor/")})
        private Chatcolor chatcolor = new Chatcolor();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/chatsetting/")})
        private Chatsetting chatsetting = new Chatsetting();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/clearchat/")})
        private Clearchat clearchat = new Clearchat();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/clearmail/")})
        private Clearmail clearmail = new Clearmail();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/coin/")})
        private Coin coin = new Coin();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/dice/")})
        private Dice dice = new Dice();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/do/")})
        private Do Do = new Do();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/flectonepulse/")})
        private Flectonepulse flectonepulse = new Flectonepulse();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/geolocate/")})
        private Geolocate geolocate = new Geolocate();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/helper/")})
        private Helper helper = new Helper();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/ignore/")})
        private Ignore ignore = new Ignore();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/ignorelist/")})
        private Ignorelist ignorelist = new Ignorelist();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/kick/")})
        private Kick kick = new Kick();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/mail/")})
        private Mail mail = new Mail();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/maintenace/")})
        private Maintenance maintenance = new Maintenance();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/me/")})
        private Me me = new Me();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/mute/")})
        private Mute mute = new Mute();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/mutelist/")})
        private Mutelist mutelist = new Mutelist();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/online/")})
        private Online online = new Online();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/poll/")})
        private Poll poll = new Poll();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/reply/")})
        private Reply reply = new Reply();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/rockpaperscissors/")})
        private Rockpaperscissors rockpaperscissors = new Rockpaperscissors();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/spy/")})
        private Spy spy = new Spy();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/stream/")})
        private Stream stream = new Stream();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/symbol/")})
        private Symbol symbol = new Symbol();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/tell/")})
        private Tell tell = new Tell();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/tictactoe/")})
        private Tictactoe tictactoe = new Tictactoe();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/translateto/")})
        private Translateto translateto = new Translateto();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/try/")})
        private Try Try = new Try();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/unban/")})
        private Unban unban = new Unban();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/unmute/")})
        private Unmute unmute = new Unmute();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/unwarn/")})
        private Unwarn unwarn = new Unwarn();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/warn/")})
        private Warn warn = new Warn();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/command/warnlist/")})
    ...
    public static final class Integration implements IModule.IIntegration, ILocalization {
        ...
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/module/integration/discord/")})
        private Discord discord = new Discord();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/integration/telegram/")})
        private Telegram telegram = new Telegram();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/integration/twitch/")})
    ...
    public static final class Message implements IModule.IMessage, ILocalization {
        ...
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/advancement/")})
        ...
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/auto/")})
        ...
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/brand/")})
        private Brand brand = new Brand();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/bubble/")})
        private Bubble bubble = new Bubble();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/chat/")})
        private Chat chat = new Chat();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/clear/")})
        private Clear clear = new Clear();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/contact/")})
        private Contact contact = new Contact();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/death/")})
        private Death death = new Death();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/deop/")})
        private Deop deop = new Deop();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/enchant/")})
        private Enchant enchant = new Enchant();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/format/")})
        private Format format = new Format();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/gamemode/")})
        private Gamemode gamemode = new Gamemode();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/greeting/")})
        private Greeting greeting = new Greeting();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/join/")})
        ...
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/setblock/")})
        ...
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/spawnpoint/")})
        private Spawnpoint spawnpoint = new Spawnpoint();
        @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/status/")})
        ...
        public static final class Contact implements IContactMessage, ILocalization {
            ...
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/contact/afk/")})
            ...
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/contact/rightclick/")})
            private Rightclick rightclick = new Rightclick();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/contact/sign/")})
            private Sign sign = new Sign();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/contact/spit/")})
        ...
        public static final class Format implements IFormatMessage, ILocalization {
            ...
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/format/mention/")})
            private Mention mention = new Mention();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/format/moderation/")})
            private Moderation moderation = new Moderation();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/format/name_/")})
            private Name name_ = new Name();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/format/spoiler/")})
            ...
            public static final class Moderation implements IModerationFormatMessage, ILocalization {
                ...
                @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/format/moderation/swear/")})
        ...
        public static final class Status implements IStatusMessage, ILocalization {
            ...
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/status/motd/")})
            private MOTD motd = new MOTD();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/status/players/")})
            private Players players = new Players();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/status/version/")})
        ...
        public static final class Tab implements ITabMessage, ILocalization {
            ...
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/tab/header/")})
            private Header header = new Header();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/tab/footer/")})
            private Footer footer = new Footer();
            @Comment({@CommentValue(" https://flectone.net/pulse/docs/en/en_us/message/tab/playerlistname/")})
