...
public class RussianLocale implements Locale {
    ...
    public void init(Localization localization) {
        ...
        localization.command.emit.nullPlayer = "<color:#ff7171><b>⁉</b> Игрок не найден";
        ...
        localization.command.ping.format = "<fcolor:1>🖧 Пинг игрока <display_name> равен <replacement:ping>";
        ...
        localization.command.rockpaperscissors.sender = "<fcolor:2>✂ <fcolor:1>Теперь ходит <target>";
        ...
        localization.message.format.replacement.values = new LinkedHashMap<>() {{
            ...
            put("url", "<click:open_url:\"<message_1>\"><hover:show_text:\"<fcolor:2>Открыть ссылку <br><u><message_1>\"><fcolor:2><u>🗗 Ссылка</u></hover></click>");
        ...
        localization.message.sidebar.values = new LinkedList<>() {{
            add(new LinkedList<>() {{
                add(" ");
                add("<fcolor:1>Пинг <replacement:ping>");
                add(" ");
                add("<fcolor:1>FlectonePulse");
            }});
            add(new LinkedList<>() {{
                add(" ");
                add("<fcolor:2>ТПС <replacement:tps>");
                add(" ");
        ...
        localization.message.tab.footer.lists = new LinkedList<>() {{
            ...
            add(new LinkedList<>() {{
                add(" ");
                add("<fcolor:1>ТПС <replacement:tps>, Онлайн <replacement:online>");
                add(" ");
            }});
        }};
        ...
        localization.message.update.formatPlayer = "<fcolor:1><fcolor:2>(FlectonePulse) <fcolor:1>Твоя версия <fcolor:2><current_version> <fcolor:1>устарела! Обновись до <fcolor:2><latest_version> <fcolor:1>с помощью <replacement:url:https://modrinth.com/plugin/flectonepulse>, чтобы получить новые возможности!";
        ...
        localization.message.vanilla.types = new LinkedHashMap<>() {
            {
                ...
                put("advMode.setCommand.success", "<fcolor:1>\uD83E\uDD16 Команда задана: <fcolor:2><argument:0>");
                ...
                put("chat.type.advancement.challenge", "<fcolor:1>🌠 <argument:0> завершил испытание «<argument:1>»");
                put("chat.type.advancement.goal", "<fcolor:1>🌠 <argument:0> достиг цели «<argument:1>»");
                put("chat.type.advancement.task", "<fcolor:1>🌠 <argument:0> получил достижение «<argument:1>»");
                put("chat.type.achievement", "<fcolor:1>🌠 <argument:0> получил достижение «<argument:1>»");
                put("chat.type.achievement.taken", "<fcolor:1>🌠 <argument:0> потерял достижение «<argument:1>»");
                put("sleep.not_possible", "<fcolor:1>\uD83D\uDECC Никакой отдых не поможет пропустить эту ночь");
                put("sleep.players_sleeping", "<fcolor:1>\uD83D\uDECC <fcolor:2><argument:0> <fcolor:1>из <fcolor:2><argument:1> <fcolor:1>игроков спят");
                put("sleep.skipping_night", "<fcolor:1>\uD83D\uDECC Вы проспите всю ночь");
                put("item.minecraft.debug_stick.empty", "<fcolor:1>\uD83D\uDD27 Свойства объекта <fcolor:2><argument:0> <fcolor:1>не заданы");
                put("item.minecraft.debug_stick.select", "<fcolor:1>\uD83D\uDD27 выбрано «<fcolor:2><argument:0><fcolor:1>» (<fcolor:2><argument:1><fcolor:1>)");
                put("item.minecraft.debug_stick.update", "<fcolor:1>\uD83D\uDD27 «<fcolor:2><argument:0><fcolor:1>»: <fcolor:2><argument:1>");
                put("commands.advancement.grant.criterion.to.many.success",  "<fcolor:1>🌠 Условие «<fcolor:2><argument:0><fcolor:1>» достижения <argument:1> зачтено <fcolor:2><argument:2> <fcolor:1>игрокам");
                put("commands.advancement.revoke.criterion.to.many.success", "<fcolor:1>🌠 Отозвано условие «<fcolor:2><argument:0><fcolor:1>» достижения <argument:1> у <fcolor:2><argument:2> <fcolor:1>игроков");
                put("commands.advancement.grant.criterion.to.one.success", "<fcolor:1>🌠 Условие «<fcolor:2><argument:0><fcolor:1>» достижения <argument:1> зачтено игроку <argument:2>");
                put("commands.advancement.revoke.criterion.to.one.success", "<fcolor:1>🌠 Отозвано условие «<fcolor:2><argument:0><fcolor:1>» достижения <argument:1> у игрока <argument:2>");
                put("commands.achievement.give.success.all", "<fcolor:1>🌠 Выданы все достижения игроку <argument:0>");
                put("commands.achievement.take.success.all", "<fcolor:1>🌠 Отозваны все достижения у игрока <argument:0>");
                put("commands.advancement.grant.many.to.many.success", "<fcolor:1>🌠 Выдано <fcolor:2><argument:0> <fcolor:1>достижений <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.advancement.revoke.many.to.many.success",  "<fcolor:1>🌠 Отозвано <fcolor:2><argument:0> <fcolor:1>достижений у <fcolor:2><argument:1> <fcolor:1>игроков");
                put("commands.advancement.grant.many.to.one.success", "<fcolor:1>🌠 Выдано <fcolor:2><argument:0> <fcolor:1>достижений игроку <argument:1>");
                put("commands.advancement.revoke.many.to.one.success", "<fcolor:1>🌠 Отозвано <fcolor:2><argument:0> <fcolor:1>достижений у игрока <argument:1>");
                put("commands.advancement.grant.one.to.many.success", "<fcolor:1>🌠 Достижение «<argument:0>» выдано <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.advancement.revoke.one.to.many.success", "<fcolor:1>🌠 Достижение «<argument:0>» отозвано у <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.advancement.grant.one.to.one.success", "<fcolor:1>🌠 Достижение «<argument:0>» выдано игроку <argument:1>");
                put("commands.advancement.revoke.one.to.one.success", "<fcolor:1>🌠 Отозвано достижение «<argument:0>» у игрока <argument:1>");
                put("commands.achievement.give.success.one", "<fcolor:1>🌠 Достижение «<argument:0>» выдано игроку <argument:1>");
                put("commands.achievement.take.success.one", "<fcolor:1>🌠 Отозвано достижение «<argument:0>» у игрока <argument:1>");
                put("commands.attribute.base_value.get.success", "<fcolor:1>❤ Базовое значение атрибута «<fcolor:2><argument:0><fcolor:1>» у сущности <argument:1> равно <fcolor:2><argument:2>");
                put("commands.attribute.base_value.reset.success", "<fcolor:1>❤ Базовое значение атрибута «<fcolor:2><argument:0><fcolor:1>» у сущности <argument:1> возвращено к <fcolor:2><argument:2>");
                put("commands.attribute.base_value.set.success", "<fcolor:1>❤ Базовое значение атрибута «<fcolor:2><argument:0><fcolor:1>» у сущности <argument:1> изменено на <fcolor:2><argument:2>");
                put("commands.attribute.value.get.success", "<fcolor:1>❤ Значение атрибута «<fcolor:2><argument:0><fcolor:1>» у сущности <argument:1> равно <fcolor:2><argument:2>");
                put("commands.attribute.modifier.add.success", "<fcolor:1>❤ Добавлен модификатор <fcolor:2><argument:0> <fcolor:1>к атрибуту «<fcolor:2><argument:1><fcolor:1>» у сущности <argument:2>");
                put("commands.attribute.modifier.remove.success", "<fcolor:1>❤ Удалён модификатор <fcolor:2><argument:0> <fcolor:1>с атрибута «<fcolor:2><argument:1><fcolor:1>» у сущности <argument:2>");
                put("commands.attribute.modifier.value.get.success", "<fcolor:1>❤ Значение модификатора <fcolor:2><argument:0> <fcolor:1>атрибута «<fcolor:2><argument:1><fcolor:1>» у сущности <argument:2> равно <fcolor:2><argument:3>");
                put("commands.clear.success.multiple", "<fcolor:1>\uD83C\uDF0A Удалено <fcolor:2><argument:0> <fcolor:1>предметов у <fcolor:2><argument:1> <fcolor:1>игроков");
                put("commands.clear.success.single", "<fcolor:1>\uD83C\uDF0A Удалено <fcolor:2><argument:0> <fcolor:1>предметов у игрока <argument:1>");
                put("commands.clear.success", "<fcolor:1>\uD83C\uDF0A Удалено <fcolor:2><argument:1> <fcolor:1>предметов у игрока <argument:0>");
                put("commands.clone.success", "<fcolor:1>⏹ Успешно скопировано <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.damage.success", "<fcolor:1>\uD83D\uDDE1 Нанесено <fcolor:2><argument:0> <fcolor:1>урона <argument:1>");
                put("commands.deop.success", "<fcolor:1>\uD83E\uDD16 <argument:0> больше не является оператором сервера");
                put("commands.dialog.clear.multiple", "<fcolor:1>\uD83D\uDDD4 Убран диалог у <fcolor:2><argument:0> <fcolor:1>игроков");
                put("commands.dialog.clear.single", "<fcolor:1>\uD83D\uDDD4 Убран диалог у игрока «<argument:0>»");
                put("commands.dialog.show.multiple", "<fcolor:1>\uD83D\uDDD4 Отображён диалог <fcolor:2><argument:0> <fcolor:1>игрокам");
                put("commands.dialog.show.single", "<fcolor:1>\uD83D\uDDD4 Отображён диалог игроку «<argument:0>»");
                put("commands.difficulty.query", "<fcolor:1>⚔ Сложность игры: <fcolor:2><argument:0>");
                put("commands.difficulty.success", "<fcolor:1>⚔ Установлена сложность игры: <fcolor:2><argument:0>");
                put("commands.effect.clear.everything.success.multiple", "<fcolor:1>⚗ Убраны все эффекты с <fcolor:2><argument:0> <fcolor:1>целей");
                put("commands.effect.clear.everything.success.single", "<fcolor:1>⚗ Убраны все эффекты с <argument:0>");
                put("commands.effect.clear.specific.success.multiple", "<fcolor:1>⚗ Убран эффект «<fcolor:2><argument:0><fcolor:1>» с <fcolor:2><argument:1> <fcolor:1>целей");
                put("commands.effect.clear.specific.success.single", "<fcolor:1>⚗ Убран эффект «<fcolor:2><argument:0><fcolor:1>» с <argument:1>");
                put("commands.effect.give.success.multiple", "<fcolor:1>⚗ Применён эффект <fcolor:2><argument:0><fcolor:1>» к <fcolor:2><argument:1> <fcolor:1>целям");
                put("commands.effect.give.success.single", "<fcolor:1>⚗ Применён эффект «<fcolor:2><argument:0><fcolor:1>» к <argument:1>");
                put("commands.effect.success", "<fcolor:1>⚗ Применён эффект «<fcolor:2><argument:0><fcolor:1>» к <argument:3>");
                put("commands.effect.success.removed", "<fcolor:1>⚗ Убран эффект «<fcolor:2><argument:0><fcolor:1>» с <argument:1>");
                put("commands.effect.success.removed.all", "<fcolor:1>⚗ Убраны все эффекты с <argument:0>");
                put("commands.enchant.success.multiple", "<fcolor:1>\uD83D\uDCD6 Наложены чары «<fcolor:2><argument:0><fcolor:1>» на предмет <fcolor:2><argument:1><fcolor:1> сущностей");
                put("commands.enchant.success.single", "<fcolor:1>\uD83D\uDCD6 Наложены чары «<fcolor:2><argument:0><fcolor:1>» на предмет <argument:1>");
                ...
                put("commands.execute.conditional.pass_count", "<fcolor:1>⚡ Условие выполнено; счётчик: <fcolor:2><argument:0>");
                put("commands.experience.query.levels", "<fcolor:1>⏺ <argument:0> имеет <fcolor:2><argument:1> <fcolor:1>уровней");
                put("commands.experience.query.points", "<fcolor:1>⏺ <argument:0> имеет <fcolor:2><argument:1> <fcolor:1>ед. опыта");
                put("commands.experience.add.levels.success.multiple", "<fcolor:1>⏺ Выдано <fcolor:2><argument:0> <fcolor:1>уровней <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.experience.add.points.success.multiple", "<fcolor:1>⏺ Выдано <fcolor:2><argument:0> <fcolor:1>единиц опыта <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.experience.set.levels.success.multiple", "<fcolor:1>⏺ Установлено <fcolor:2><argument:0> <fcolor:1>уровней <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.experience.set.points.success.multiple", "<fcolor:1>⏺ Установлено <fcolor:2><argument:0> <fcolor:1>единиц опыта <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.experience.add.levels.success.single", "<fcolor:1>⏺ Выдано <fcolor:2><argument:0> <fcolor:1>уровней игроку <argument:1>");
                put("commands.experience.add.points.success.single", "<fcolor:1>⏺ Выдано <fcolor:2><argument:0> <fcolor:1>единиц опыта игроку <argument:1>");
                put("commands.experience.set.levels.success.single", "<fcolor:1>⏺ Установлено <fcolor:2><argument:0> <fcolor:1>уровней игроку <argument:1>");
                put("commands.experience.set.points.success.single", "<fcolor:1>⏺ Установлено <fcolor:2><argument:0> <fcolor:1>единиц опыта игроку <argument:1>");
                put("commands.xp.success", "<fcolor:1>⏺ Выдано <fcolor:2><argument:0> <fcolor:1>единиц опыта игроку <argument:1>");
                put("commands.xp.success.levels", "<fcolor:1>⏺ Выдано <fcolor:2><argument:0> <fcolor:1>уровней игроку <argument:1>");
                put("commands.xp.success.negative.levels", "<fcolor:1>⏺ <argument:0> потерял <fcolor:2><argument:1> <fcolor:1>уровней");
                put("commands.fill.success", "<fcolor:1>⏹ Успешно заполнено <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.fillbiome.success", "<fcolor:1>⏹ Заменены биомы между точками <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2> <fcolor:1>и <fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>, <fcolor:2><argument:5>");
                put("commands.fillbiome.success.count", "<fcolor:1>⏹ Биом был заменён у <fcolor:2><argument:0> <fcolor:1>блоков между точками <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>, <fcolor:2><argument:3> <fcolor:1>и <fcolor:2><argument:4><fcolor:1>, <fcolor:2><argument:5><fcolor:1>, <fcolor:2><argument:6>");
                put("gameMode.changed", "<fcolor:1>\uD83D\uDDD8 Ваш игровой режим изменён на <fcolor:2><argument:0>");
                put("commands.gamemode.success.other", "<fcolor:1>\uD83D\uDDD8 Режим игры игрока <argument:0> изменён на <fcolor:2><argument:1>");
                put("commands.gamemode.success.self", "<fcolor:1>\uD83D\uDDD8 Твой режим игры изменён на <fcolor:2><argument:0>");
                put("commands.defaultgamemode.success", "<fcolor:1>\uD83D\uDDD8 Новый режим игры по умолчанию: <fcolor:2><argument:0>");
                put("commands.gamerule.query", "<fcolor:1>\uD83D\uDDD0 Значение игрового правила <fcolor:2><argument:0><fcolor:1>: <fcolor:2><argument:1>");
                put("commands.gamerule.set", "<fcolor:1>\uD83D\uDDD0 Установлено значение игрового правила <fcolor:2><argument:0><fcolor:1>: <fcolor:2><argument:1>");
                put("commands.gamerule.success", "<fcolor:1>\uD83D\uDDD0 Игровое правило изменено");
                put("commands.give.successcommands.give.success.multiple", "<fcolor:1>⛏ Выдано <fcolor:2><argument:0> <fcolor:2><argument:1><fcolor:1> <fcolor:2><argument:2> <fcolor:1>игрокам");
                put("commands.give.success.single", "<fcolor:1>⛏ Выдано <fcolor:2><argument:0> <fcolor:2><argument:1><fcolor:1> игроку <argument:2>");
                put("commands.give.success", "<fcolor:1>⛏ Выдано <fcolor:2><argument:1><fcolor:1> * <fcolor:2><argument:0><fcolor:1> игроку <argument:2>");
                ...
                put("commands.locate.success", "<fcolor:1>\uD83D\uDDFA Ближайшее строение типа <fcolor:2><argument:0><fcolor:1> находится по координатам <fcolor:2><argument:1><fcolor:1> (в <fcolor:2><argument:2> <fcolor:1>блоках отсюда)");
                put("commands.locatebiome.success", "<fcolor:1>\uD83D\uDDFA Ближайший биом с типом <fcolor:2><argument:0><fcolor:1> находится по координатам <fcolor:2><argument:1><fcolor:1> (в <fcolor:2><argument:2> <fcolor:1>блоках отсюда)");
                put("commands.op.success", "<fcolor:1>\uD83E\uDD16 <argument:0> назначен оператором сервера");
                put("commands.particle.success", "<fcolor:1>❄ Отображена частица «<fcolor:2><argument:0><fcolor:1>»");
                put("commands.recipe.give.success.multiple", "<fcolor:1>\uD83D\uDCA1 Выдан(о) <fcolor:2><argument:0> <fcolor:1>рецепт(ов) <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.recipe.give.success.single", "<fcolor:1>\uD83D\uDCA1 Выдано <fcolor:2><argument:0> <fcolor:1>рецептов игроку <argument:1>");
                put("commands.recipe.take.success.multiple", "<fcolor:1>\uD83D\uDCA1 Изъято <fcolor:2><argument:0> <fcolor:1>рецептов у <fcolor:2><argument:1> <fcolor:1>игроков");
                put("commands.recipe.take.success.single", "<fcolor:1>\uD83D\uDCA1 Изъято <fcolor:2><argument:0> <fcolor:1>рецептов у игрока <argument:1>");
                put("commands.reload.success", "<fcolor:1>\uD83D\uDEC8 Перезагрузка!");
                put("commands.ride.dismount.success", "<fcolor:1>\uD83C\uDFC7 <argument:0> больше не сидит на <argument:1>");
                put("commands.ride.mount.success", "<fcolor:1>\uD83C\uDFC7 <argument:0> теперь сидит на <argument:1>");
                put("commands.rotate.success", "<fcolor:1>\uD83E\uDD38 <argument:0> повёрнут");
                ...
                put("commands.seed.success", "<fcolor:1>\uD83D\uDD11 Ключ генератора: <argument:0>");
                put("commands.setblock.success.1_19_4", "<fcolor:1>⏹ Изменён блок");
                put("commands.setblock.success", "<fcolor:1>⏹ Изменён блок в точке <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>");
                put("commands.playsound.success.multiple", "<fcolor:1>\uD83D\uDD0A Воспроизведён звук «<fcolor:2><argument:0><fcolor:1>» <fcolor:2><argument:1> <fcolor:1>игрокам");
                put("commands.playsound.success.single", "<fcolor:1>\uD83D\uDD0A Воспроизведён звук «<fcolor:2><argument:0><fcolor:1>» игроку <argument:1>");
                put("commands.stopsound.success.all", "<fcolor:1>\uD83D\uDD07 Отключены все звуки от источника «<fcolor:2><argument:0><fcolor:1>»");
                put("commands.stopsound.success.soundSource", "<fcolor:1>\uD83D\uDD07 Отключены все звуки");
                put("commands.stopsound.success.individualSound", "<fcolor:1>\uD83D\uDD07 Отключён звук «<fcolor:2><argument:0><fcolor:1>» от источника «<fcolor:2><argument:1><fcolor:1>»");
                put("commands.playsound.success", "<fcolor:1>\uD83D\uDD0A Воспроизведён звук «<fcolor:2><argument:0><fcolor:1>» игроку <argument:1>");
                put("commands.stopsound.success.source.any", "<fcolor:1>\uD83D\uDD07 Отключены все звуки от источника «<fcolor:2><argument:0><fcolor:1>»");
                put("commands.stopsound.success.source.sound",  "<fcolor:1>\uD83D\uDD07 Отключён звук «<fcolor:2><argument:0><fcolor:1>» от источника «<fcolor:2><argument:1><fcolor:1>»");
                put("commands.stopsound.success.sourceless.any", "<fcolor:1>\uD83D\uDD07 Отключены все звуки");
                put("commands.stopsound.success.sourceless.sound", "<fcolor:1>\uD83D\uDD07 Отключён звук «<fcolor:2><argument:0><fcolor:1>»");
                put("commands.spawnpoint.success", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> <fcolor:1>для <argument:3>");
                put("commands.setworldspawn.success.1_16", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения мира <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>");
                put("commands.setworldspawn.success.1_21_8", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения мира <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>]");
                put("commands.setworldspawn.success", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения мира <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] в <fcolor:2><argument:5>");
                put("commands.setworldspawn.success.new", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения мира <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] в <fcolor:2><argument:5>");
                put("commands.spawnpoint.success.multiple.1_14_2", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> для <fcolor:2><argument:3><fcolor:1> игроков");
                put("commands.spawnpoint.success.multiple.1_21_8", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>] в <fcolor:2><argument:4> <fcolor:1>для <fcolor:2><argument:5><fcolor:1> игроков");
                put("commands.spawnpoint.success.multiple", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] в <fcolor:2><argument:5> <fcolor:1>для <fcolor:2><argument:6><fcolor:1> игроков");
                put("commands.spawnpoint.success.multiple.new", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] в <fcolor:2><argument:5> <fcolor:1>для <fcolor:2><argument:6><fcolor:1> игроков");
                put("commands.spawnpoint.success.single.1_14_2", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> <fcolor:1>для <argument:3>");
                put("commands.spawnpoint.success.single.1_21_8", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>] в <fcolor:2><argument:4> <fcolor:1>для <argument:5>");
                put("commands.spawnpoint.success.single", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] в <fcolor:2><argument:5> <fcolor:1>для <argument:6>");
                put("commands.spawnpoint.success.single.new", "<fcolor:1>\uD83D\uDECC Установлена точка возрождения <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] в <fcolor:2><argument:5> <fcolor:1>для <argument:6>");
                put("commands.stop.stopping", "<fcolor:1>\uD83D\uDEC8 Выключение сервера");
                put("commands.stop.start", "<fcolor:1>\uD83D\uDEC8 Выключение сервера");
                put("commands.summon.success", "<fcolor:1>\uD83D\uDC3A Сущность «<argument:0>» создана");
                put("commands.teleport.success.entity.multiple", "<fcolor:1>\uD83C\uDF00 <fcolor:2><argument:0> <fcolor:1>сущностей телепортированы к <argument:1>");
                put("commands.teleport.success.entity.single", "<fcolor:1>\uD83C\uDF00 <argument:0> телепортирован к <argument:1>");
                put("commands.tp.success", "<fcolor:1>\uD83C\uDF00 <argument:0> телепортирован к <argument:1>");
                put("commands.teleport.success.location.multiple", "<fcolor:1>\uD83C\uDF00 <fcolor:2><argument:0> <fcolor:1>сущностей телепортированы в точку <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>, <fcolor:2><argument:3><fcolor:1>");
                put("commands.teleport.success.location.single", "<fcolor:1>\uD83C\uDF00 <argument:0> телепортирован в точку <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>, <fcolor:2><argument:3><fcolor:1>");
                put("commands.tp.success.coordinates", "<fcolor:1>\uD83C\uDF00 <argument:0> телепортирован в точку <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>, <fcolor:2><argument:3><fcolor:1>");
                put("commands.time.query", "<fcolor:1>☽ Время: <fcolor:2><argument:0>");
                put("commands.time.set", "<fcolor:1>☽ Установлено время: <fcolor:2><argument:0>");
                ...
                put("commands.worldborder.center.success", "<fcolor:1>\uD83D\uDEAB Установлен центр границ мира: <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1>");
                put("commands.worldborder.damage.amount.success", "<fcolor:1>\uD83D\uDEAB Установлено значение урона, ежесекундно наносимого за границами мира: <fcolor:2><argument:0> <fcolor:1>за блок");
                put("commands.worldborder.damage.buffer.success", "<fcolor:1>\uD83D\uDEAB Установлен предел нанесения урона за границами мира: <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.get.success", "<fcolor:1>\uD83D\uDEAB Ширина границы мира: <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.get", "<fcolor:1>\uD83D\uDEAB Ширина границы мира: <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.set.success", "<fcolor:1>\uD83D\uDEAB Установлена граница мира шириной <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.setSlowly.grow.success", "<fcolor:1>\uD83D\uDEAB Через <fcolor:2><argument:2> <fcolor:1>секунд ширина границы мира увеличится до <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.set.grow", "<fcolor:1>\uD83D\uDEAB Через <fcolor:2><argument:1> <fcolor:1>секунд ширина границы мира увеличится до <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.set.immediate", "<fcolor:1>\uD83D\uDEAB Установлена граница мира шириной <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.setSlowly.shrink.success", "<fcolor:1>\uD83D\uDEAB Через <fcolor:2><argument:2> <fcolor:1>секунд ширина границы мира уменьшится до <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.set.shrink", "<fcolor:1>\uD83D\uDEAB Через <fcolor:2><argument:1> <fcolor:1>секунд ширина границы мира уменьшится до <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.warning.distance.success", "<fcolor:1>\uD83D\uDEAB Установлено расстояние предупреждения о пересечении границы мира: <fcolor:2><argument:0> <fcolor:1>блоков");
                put("commands.worldborder.warning.time.success", "<fcolor:1>\uD83D\uDEAB Установлено время предупреждения о столкновении с границей мира: <fcolor:2><argument:0> <fcolor:1>секунд");
                put("death.attack.anvil", "<fcolor:1>☠ <argument:0> раздавлен упавшей наковальней");
                put("death.attack.anvil.player", "<fcolor:1>☠ <argument:0> был раздавлен упавшей наковальней, пока боролся с <argument:1>");
                put("death.attack.arrow", "<fcolor:1>☠ <argument:0> застрелен <argument:1>");
                put("death.attack.arrow.item", "<fcolor:1>☠ <argument:0> застрелен <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.badRespawnPoint.message", "<fcolor:1>☠ <argument:0> стал жертвой <fcolor:2>[<click:open_url:\"https://www.youtube.com/watch?v=dQw4w9WgXcQ\"><hover:show_text:\"<fcolor:2>MCPE-28723\">жестоких правил игры</hover></click>]");
                put("death.attack.cactus", "<fcolor:1>☠ <argument:0> исколот до смерти");
                put("death.attack.cactus.player", "<fcolor:1>☠ <argument:0> наткнулся на кактус, спасаясь от <argument:1>");
                put("death.attack.cramming", "<fcolor:1>☠ <argument:0> расплющен в лепёшку");
                put("death.attack.cramming.player", "<fcolor:1>☠ <argument:0> расплющен <argument:1>");
                put("death.attack.dragonBreath", "<fcolor:1>☠ <argument:0> испепелён дыханием дракона");
                put("death.attack.dragonBreath.player", "<fcolor:1>☠ <argument:0> сварился заживо в драконьем дыхании из-за <argument:1>");
                put("death.attack.drown", "<fcolor:1>☠ <argument:0> утонул");
                put("death.attack.drown.player", "<fcolor:1>☠ <argument:0> утонул, спасаясь от <argument:1>");
                put("death.attack.dryout", "<fcolor:1>☠ <argument:0> умер от обезвоживания");
                put("death.attack.dryout.player", "<fcolor:1>☠ <argument:0> умер от обезвоживания, спасаясь от <argument:1>");
                put("death.attack.even_more_magic", "<fcolor:1>☠ <argument:0> был убит неизведанной магией");
                put("death.attack.explosion", "<fcolor:1>☠ <argument:0> взорвался");
                put("death.attack.explosion.player", "<fcolor:1>☠ <argument:0> был взорван <argument:1>");
                put("death.attack.explosion.item", "<fcolor:1>☠ <argument:0> был взорван <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.explosion.player.item", "<fcolor:1>☠ <argument:0> был взорван <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.fall", "<fcolor:1>☠ <argument:0> разбился вдребезги");
                put("death.attack.fall.player", "<fcolor:1>☠ <argument:0> разбился вдребезги, спасаясь от <argument:1>");
                put("death.attack.fallingBlock", "<fcolor:1>☠ <argument:0> раздавлен упавшим блоком");
                put("death.attack.fallingBlock.player", "<fcolor:1>☠ <argument:0> был раздавлен упавшим блоком, пока боролся с <argument:1>");
                put("death.attack.fallingStalactite", "<fcolor:1>☠ <argument:0> был пронзён обрушившимся сталактитом");
                put("death.attack.fallingStalactite.player", "<fcolor:1>☠ <argument:0> был пронзён обрушившимся сталактитом, пока боролся с <argument:1>");
                put("death.attack.fireball", "<fcolor:1>☠ <argument:0> убит файерболом <argument:1>");
                put("death.attack.fireball.item", "<fcolor:1>☠ <argument:0> убит файерболом <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.fireworks", "<fcolor:1>☠ <argument:0> с треском разлетелся");
                put("death.attack.fireworks.item", "<fcolor:1>☠ <argument:0> с треском разлетелся из-за фейерверка <argument:1>, выпущенного из <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.fireworks.player", "<fcolor:1>☠ <argument:0> с треском разлетелся, пока боролся с <argument:1>");
                put("death.attack.flyIntoWall", "<fcolor:1>☠ <argument:0> преобразовал кинетическую энергию во внутреннюю");
                put("death.attack.flyIntoWall.player", "<fcolor:1>☠ <argument:0> преобразовал кинетическую энергию во внутреннюю, спасаясь от <argument:1>");
                put("death.attack.freeze", "<fcolor:1>☠ <argument:0> замёрз насмерть");
                put("death.attack.freeze.player", "<fcolor:1>☠ <argument:0> замёрз насмерть благодаря <argument:1>");
                put("death.attack.generic", "<fcolor:1>☠ <argument:0> умер");
                put("death.attack.generic.player", "<fcolor:1>☠ <argument:0> умер из-за <argument:1>");
                put("death.attack.genericKill", "<fcolor:1>☠ <argument:0> убит");
                put("death.attack.genericKill.player", "<fcolor:1>☠ <argument:0> был убит, сражаясь с <argument:1>");
                put("death.attack.hotFloor", "<fcolor:1>☠ <argument:0> обнаружил, что пол — это лава");
                put("death.attack.hotFloor.player", "<fcolor:1>☠ <argument:0> зашёл в опасную зону из-за <argument:1>");
                put("death.attack.inFire", "<fcolor:1>☠ <argument:0> умер в огне");
                put("death.attack.inFire.player", "<fcolor:1>☠ <argument:0> сгорел в огне, пока боролся с <argument:1>");
                put("death.attack.inWall", "<fcolor:1>☠ <argument:0> погребён заживо");
                put("death.attack.inWall.player", "<fcolor:1>☠ <argument:0> был погребён заживо, пока боролся с <argument:1>");
                put("death.attack.indirectMagic", "<fcolor:1>☠ <argument:0> был убит <argument:1> с помощью магии");
                put("death.attack.indirectMagic.item", "<fcolor:1>☠ <argument:0> был убит <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.lava", "<fcolor:1>☠ <argument:0> решил поплавать в лаве");
                put("death.attack.lava.player", "<fcolor:1>☠ <argument:0> упал в лаву, убегая от <argument:1>");
                put("death.attack.lightningBolt", "<fcolor:1>☠ <argument:0> был поражён молнией");
                put("death.attack.lightningBolt.player", "<fcolor:1>☠ <argument:0> был поражён молнией, пока боролся с <argument:1>");
                put("death.attack.mace_smash", "<fcolor:1>☠ <argument:0> был сокрушён <argument:1>");
                put("death.attack.mace_smash.item", "<fcolor:1>☠ <argument:0> был сокрушён <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.magic", "<fcolor:1>☠ <argument:0> был убит магией");
                put("death.attack.magic.player", "<fcolor:1>☠ <argument:0> был убит магией, убегая от <argument:1>");
                put("death.attack.mob", "<fcolor:1>☠ <argument:0> был убит <argument:1>");
                put("death.attack.mob.item", "<fcolor:1>☠ <argument:0> был убит <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.onFire", "<fcolor:1>☠ <argument:0> сгорел заживо");
                put("death.attack.onFire.item", "<fcolor:1>☠ <argument:0> был сожжён дотла, пока боролся с <argument:1>, держащим <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.onFire.player", "<fcolor:1>☠ <argument:0> был сожжён дотла, пока боролся с <argument:1>");
                put("death.attack.outOfWorld", "<fcolor:1>☠ <argument:0> выпал из мира");
                put("death.attack.outOfWorld.player", "<fcolor:1>☠ <argument:0> не захотел жить в том же мире, что и <argument:1>");
                put("death.attack.outsideBorder", "<fcolor:1>☠ <argument:0> покинул пределы этого мира");
                put("death.attack.outsideBorder.player", "<fcolor:1>☠ <argument:0> покинул пределы этого мира, пока боролся с <argument:1>");
                put("death.attack.player", "<fcolor:1>☠ <argument:0> был убит <argument:1>");
                put("death.attack.player.item", "<fcolor:1>☠ <argument:0> был убит <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                ...
                put("death.attack.starve.player", "<fcolor:1>☠ <argument:0> умер от голода, пока боролся с <argument:1>");
                put("death.attack.sting", "<fcolor:1>☠ <argument:0> изжален до смерти");
                put("death.attack.sting.item", "<fcolor:1>☠ <argument:0> был изжален до смерти <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.sting.player", "<fcolor:1>☠ <argument:0> изжален до смерти <argument:1>");
                put("death.attack.sweetBerryBush", "<fcolor:1>☠ <argument:0> искололся до смерти в кустах сладких ягод");
                put("death.attack.sweetBerryBush.player", "<fcolor:1>☠ <argument:0> искололся до смерти в кустах сладких ягод, спасаясь от <argument:1>");
                put("death.attack.thorns", "<fcolor:1>☠ <argument:0> был убит, пытаясь навредить <argument:1>");
                put("death.attack.thorns.item", "<fcolor:1>☠ <argument:0> был убит <fcolor:2><argument:2><fcolor:1>, пытаясь навредить <argument:1>");
                put("death.attack.thrown", "<fcolor:1>☠ <argument:0> был избит <argument:1>");
                put("death.attack.thrown.item", "<fcolor:1>☠ <argument:0> был избит <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.trident", "<fcolor:1>☠ <argument:0> был пронзён <argument:1>");
                put("death.attack.trident.item", "<fcolor:1>☠ <argument:0> пронзён <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.wither", "<fcolor:1>☠ <argument:0> иссушён");
                put("death.attack.wither.player", "<fcolor:1>☠ <argument:0> был иссушён, пока боролся с <argument:1>");
                put("death.attack.witherSkull", "<fcolor:1>☠ <argument:0> был поражён черепом из <argument:1>");
                put("death.attack.witherSkull.item", "<fcolor:1>☠ <argument:0> был поражён черепом из <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.fell.accident.generic", "<fcolor:1>☠ <argument:0> разбился насмерть");
                put("death.fell.accident.ladder", "<fcolor:1>☠ <argument:0> свалился с лестницы");
                put("death.fell.accident.other_climbable", "<fcolor:1>☠ <argument:0> сорвался");
                put("death.fell.accident.scaffolding", "<fcolor:1>☠ <argument:0> сорвался с подмосток");
                put("death.fell.accident.twisting_vines", "<fcolor:1>☠ <argument:0> сорвался с вьющейся лозы");
                put("death.fell.accident.vines", "<fcolor:1>☠ <argument:0> сорвался с лианы");
                put("death.fell.accident.weeping_vines", "<fcolor:1>☠ <argument:0> сорвался с плакучей лозы");
                put("death.fell.assist", "<fcolor:1>☠ <argument:0> свалился благодаря <argument:1>");
                put("death.fell.assist.item", "<fcolor:1>☠ <argument:0> был обречён на падение <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.fell.finish", "<fcolor:1>☠ <argument:0> упал с высоты и был добит <argument:1>");
                put("death.fell.finish.item", "<fcolor:1>☠ <argument:0> упал с высоты и был добит <argument:1> с помощью <fcolor:2><argument:2><fcolor:1>");
                put("death.fell.killer", "<fcolor:1>☠ <argument:0> был обречён на падение");
            }
        };
    }
}
