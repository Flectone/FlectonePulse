...
public final class Localization extends FileSerializable implements ModuleConfig {
    ...
    private void initRU_RU() {
        ...
        command.chatsetting.checkbox.types.put(MessageType.ADVANCEMENT.name(), "<status_color>Advancement");
        command.chatsetting.checkbox.types.put(MessageType.AFK.name(), "<status_color>Command /afk");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_ANON.name(), "<status_color>Command /anon");
        command.chatsetting.checkbox.types.put(MessageType.AUTO.name(), "<status_color>Auto Message");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_BALL.name(), "<status_color>Command /ball");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_BAN.name(), "<status_color>Command /ban");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_BROADCAST.name(), "<status_color>Command /broadcast");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_COIN.name(), "<status_color>Command /coin");
        command.chatsetting.checkbox.types.put(MessageType.DEATH.name(), "<status_color>Death");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_DICE.name(), "<status_color>Command /dice");
        command.chatsetting.checkbox.types.put(MessageType.FROM_DISCORD_TO_MINECRAFT.name(), "<status_color>Messages from Discord");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_DO.name(), "<status_color>Command /do");
        command.chatsetting.checkbox.types.put(MessageType.GREETING.name(), "<status_color>Greeting message");
        command.chatsetting.checkbox.types.put(MessageType.JOIN.name(), "<status_color>Join");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_KICK.name(), "<status_color>Command /kick");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_MAIL.name(), "<status_color>Command /mail");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_ME.name(), "<status_color>Command /me");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_MUTE.name(), "<status_color>Command /mute");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_POLL.name(), "<status_color>Command /poll");
        command.chatsetting.checkbox.types.put(MessageType.QUIT.name(), "<status_color>Quit");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_REPLY.name(), "<status_color>Command /reply");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_ROCKPAPERSCISSORS.name(), "<status_color>Command /rockpaperscissors");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_SPY.name(), "<status_color>Spy");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_STREAM.name(), "<status_color>Stream");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_TELL.name(), "<status_color>Command /tell");
        command.chatsetting.checkbox.types.put(MessageType.FROM_TELEGRAM_TO_MINECRAFT.name(), "<status_color>Messages from Telegram");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_TICTACTOE.name(), "<status_color>Command /tictactoe");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_TRANSLATETO.name(), "<status_color>Command /translateto");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_TRY.name(), "<status_color>Command /try");
        command.chatsetting.checkbox.types.put(MessageType.FROM_TWITCH_TO_MINECRAFT.name(), "<status_color>Messages from Twitch");
        command.chatsetting.checkbox.types.put(MessageType.COMMAND_WARN.name(), "<status_color>Command /warn");
                ...
                private Map<String, String> types = new LinkedHashMap<>() {
                    {
                        ...
                        put(MessageType.AFK.name(), "<status_color>Command /afk");
                        put(MessageType.COMMAND_ANON.name(), "<status_color>Command /anon");
                        put(MessageType.AUTO.name(), "<status_color>Auto Message");
                        put(MessageType.COMMAND_BALL.name(), "<status_color>Command /ball");
                        put(MessageType.COMMAND_BAN.name(), "<status_color>Command /ban");
                        ...
                        put(MessageType.COMMAND_TRANSLATETO.name(), "<status_color>Command /translateto");
                        ...
                        put(MessageType.COMMAND_WARN.name(), "<status_color>Command /warn");
                    }
                };
            }
