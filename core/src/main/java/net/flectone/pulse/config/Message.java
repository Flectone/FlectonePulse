        ...
        private List<VanillaMessage> types = new LinkedList<>() {
            {
                ...
                add(new VanillaMessage(MessageType.DEATH.name(), true, Range.get(Range.Type.SERVER), List.of(
                        ...
                        "death.attack.outOfWorld.player", "death.attack.outsideBorder", "death.attack.outsideBorder.player", "death.attack.player", "death.attack.player.item", "death.attack.spear", "death.attack.spear.item", "death.attack.sonic_boom",
