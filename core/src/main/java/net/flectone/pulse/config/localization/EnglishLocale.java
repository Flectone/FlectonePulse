...
public class EnglishLocale implements Locale {
    ...
    public void init(Localization localization) {
        ...
        localization.integration.discord.formatReply = "<fcolor:4><hover:show_text:'<fcolor:4><reply_message>'>[Reply to @<reply_user>]</hover> ";
        ...
        localization.integration.telegram.formatReply = "<fcolor:4><hover:show_text:'<fcolor:4><reply_message>'>[Reply to @<reply_user>]</hover> ";
        ...
        localization.integration.twitch.formatReply = "<fcolor:4><hover:show_text:'<fcolor:4><reply_message>'>[Reply to @<reply_user>]</hover> ";
        ...
        localization.integration.twitch.messageChannel = new LinkedHashMap<>() {{
            put(MessageType.FROM_TWITCH_TO_MINECRAFT.name(), "<fcolor:2><name> <fcolor:1>» <fcolor:4><reply><message>");
            put("CHAT_GLOBAL", "<final_message>");
        }};
        ...
        localization.message.vanilla.types = new LinkedHashMap<>() {
            {
                ...
                put("advMode.setCommand.success", "<fcolor:1>\uD83E\uDD16 Command set: <fcolor:2><argument:0>");
                ...
                put("chat.type.advancement.challenge", "<fcolor:1>🌠 <argument:0> has made the advancement <argument:1>");
                put("chat.type.advancement.goal", "<fcolor:1>🌠 <argument:0> has reached the goal <argument:1>");
                put("chat.type.advancement.task", "<fcolor:1>🌠 <argument:0> has completed the challenge <argument:1>");
                put("chat.type.achievement", "<fcolor:1>🌠 <argument:0> has completed the challenge <argument:1>");
                put("chat.type.achievement.taken", "<fcolor:1>🌠 <argument:0> has lost the achievement '<argument:1>'");
                put("sleep.not_possible", "<fcolor:1>\uD83D\uDECC No amount of rest can pass this night");
                put("sleep.players_sleeping", "<fcolor:1>\uD83D\uDECC <fcolor:2><argument:0><fcolor:1>/<fcolor:2><argument:1><fcolor:1> players sleeping");
                put("sleep.skipping_night", "<fcolor:1>\uD83D\uDECC Sleeping through this night");
                put("item.minecraft.debug_stick.empty", "<fcolor:1>\uD83D\uDD27 <fcolor:2><argument:0> <fcolor:1>has no properties");
                put("item.minecraft.debug_stick.select", "<fcolor:1>\uD83D\uDD27 selected \"<fcolor:2><argument:0><fcolor:1>\" (<fcolor:2><argument:1><fcolor:1>)");
                put("item.minecraft.debug_stick.update", "<fcolor:1>\uD83D\uDD27 \"<fcolor:2><argument:0><fcolor:1>\" to <fcolor:2><argument:1>");
                put("commands.clear.success.multiple", "<fcolor:1>\uD83C\uDF0A Removed <fcolor:2><argument:0> <fcolor:1>item(s) from <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.clear.success.single", "<fcolor:1>\uD83C\uDF0A Removed <fcolor:2><argument:0> <fcolor:1>item(s) from player <argument:1>");
                put("commands.clear.success", "<fcolor:1>\uD83C\uDF0A Removed <fcolor:2><argument:1> <fcolor:1>item(s) from player <argument:0>");
                put("commands.advancement.grant.criterion.to.many.success",  "<fcolor:1>🌠 Granted criterion '<fcolor:2><argument:0><fcolor:1>' of advancement <argument:1> to <fcolor:2><argument:2> <fcolor:1>players");
                put("commands.advancement.revoke.criterion.to.many.success","<fcolor:1>🌠 Revoked criterion '<fcolor:2><argument:0><fcolor:1>' of advancement <argument:1> from <fcolor:2><argument:2> <fcolor:1>players");
                put("commands.advancement.grant.criterion.to.one.success", "<fcolor:1>🌠 Granted criterion '<fcolor:2><argument:0><fcolor:1>' of advancement <argument:1> to <argument:2>");
                put("commands.advancement.revoke.criterion.to.one.success", "<fcolor:1>🌠 Revoked criterion '<fcolor:2><argument:0><fcolor:1>' of advancement <argument:1> from <argument:2>");
                put("commands.achievement.give.success.all", "<fcolor:1>🌠 Granted all advancements to <argument:0>");
                put("commands.achievement.take.success.all", "<fcolor:1>🌠 Revoked all advancements from <argument:0>");
                put("commands.advancement.grant.many.to.many.success", "<fcolor:1>🌠 Granted <fcolor:2><argument:0> <fcolor:1>advancements to <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.advancement.revoke.many.to.many.success",  "<fcolor:1>🌠 Revoked <fcolor:2><argument:0> <fcolor:1>advancements from <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.advancement.grant.many.to.one.success", "<fcolor:1>🌠 Granted <fcolor:2><argument:0> <fcolor:1>advancements to <argument:1>");
                put("commands.advancement.revoke.many.to.one.success", "<fcolor:1>🌠 Revoked <fcolor:2><argument:0> <fcolor:1>advancements from <argument:1>");
                put("commands.advancement.grant.one.to.many.success", "<fcolor:1>🌠 Granted the advancement <argument:0> to <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.advancement.revoke.one.to.many.success", "<fcolor:1>🌠 Revoked the advancement <argument:0> from <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.advancement.grant.one.to.one.success", "<fcolor:1>🌠 Granted the advancement <argument:0> to <argument:1>");
                put("commands.advancement.revoke.one.to.one.success", "<fcolor:1>🌠 Revoked the advancement <argument:0> from <argument:1>");
                put("commands.achievement.give.success.one", "<fcolor:1>🌠 Granted the advancement <argument:0> to <argument:1>");
                put("commands.achievement.take.success.one", "<fcolor:1>🌠 Revoked the advancement <argument:0> from <argument:1>");
                put("commands.attribute.base_value.get.success", "<fcolor:1>❤ Base value of attribute <fcolor:2><argument:0> <fcolor:1>for entity <argument:1> is <fcolor:2><argument:2>");
                put("commands.attribute.base_value.reset.success", "<fcolor:1>❤ Base value for attribute <fcolor:2><argument:0> <fcolor:1>for entity <argument:1> reset to default <fcolor:2><argument:2>");
                put("commands.attribute.base_value.set.success", "<fcolor:1>❤ Base value for attribute <fcolor:2><argument:0> <fcolor:1>for entity <argument:1> set to <fcolor:2><argument:2>");
                put("commands.attribute.value.get.success", "<fcolor:1>❤ Value of attribute <fcolor:2><argument:0> <fcolor:1>for entity <argument:1> is <fcolor:2><argument:2>");
                put("commands.attribute.modifier.add.success", "<fcolor:1>❤ Added modifier <fcolor:2><argument:0> <fcolor:1>to attribute <fcolor:2><argument:1> <fcolor:1>for entity <argument:2>");
                put("commands.attribute.modifier.remove.success", "<fcolor:1>❤ Removed modifier <fcolor:2><argument:0> <fcolor:1>from attribute <fcolor:2><argument:1> <fcolor:1>for entity <argument:2>");
                put("commands.attribute.modifier.value.get.success", "<fcolor:1>❤ Value of modifier <fcolor:2><argument:0> <fcolor:1>on attribute <fcolor:2><argument:1> <fcolor:1>for entity <argument:2> is <fcolor:2><argument:3>");
                put("commands.clone.success", "<fcolor:1>⏹ Successfully cloned <fcolor:2><argument:0> <fcolor:1>block(s)");
                put("commands.damage.success", "<fcolor:1>\uD83D\uDDE1 Applied <fcolor:2><argument:0> <fcolor:1>damage to <argument:1>");
                put("commands.deop.success", "<fcolor:1>\uD83E\uDD16 Made <argument:0> no longer a server operator");
                put("commands.dialog.clear.multiple", "<fcolor:1>\uD83D\uDDD4 Cleared dialog for <fcolor:2><argument:0> <fcolor:1>players");
                put("commands.dialog.clear.single", "<fcolor:1>\uD83D\uDDD4 Cleared dialog for <argument:0>");
                put("commands.dialog.show.multiple", "<fcolor:1>\uD83D\uDDD4 Displayed dialog to <fcolor:2><argument:0> <fcolor:1>players");
                put("commands.dialog.show.single", "<fcolor:1>\uD83D\uDDD4 Displayed dialog to <argument:0>");
                put("commands.difficulty.query", "<fcolor:1>⚔ The difficulty is <fcolor:2><argument:0>");
                put("commands.difficulty.success", "<fcolor:1>⚔ The difficulty has been set to <fcolor:2><argument:0>");
                put("commands.effect.clear.everything.success.multiple", "<fcolor:1>⚗ Removed every effect from <fcolor:2><argument:0> <fcolor:1>targets");
                put("commands.effect.clear.everything.success.single", "<fcolor:1>⚗ Removed every effect from <argument:0>");
                put("commands.effect.clear.specific.success.multiple", "<fcolor:1>⚗ Removed effect <fcolor:2><argument:0> <fcolor:1>from <fcolor:2><argument:1> <fcolor:1>targets");
                put("commands.effect.clear.specific.success.single", "<fcolor:1>⚗ Removed effect <fcolor:2><argument:0> <fcolor:1>from <argument:1>");
                put("commands.effect.give.success.multiple", "<fcolor:1>⚗ Applied effect <fcolor:2><argument:0> <fcolor:1>to <fcolor:2><argument:1> <fcolor:1>targets");
                put("commands.effect.give.success.single", "<fcolor:1>⚗ Applied effect <fcolor:2><argument:0> <fcolor:1>to <argument:1>");
                put("commands.effect.success", "<fcolor:1>⚗ Applied effect <fcolor:2><argument:0> <fcolor:1>to <argument:3>");
                put("commands.effect.success.removed", "<fcolor:1>⚗ Removed effect <fcolor:2><argument:0> <fcolor:1>from <argument:1>");
                put("commands.effect.success.removed.all", "<fcolor:1>⚗ Removed every effect from <argument:0>");
                put("commands.enchant.success.multiple", "<fcolor:1>\uD83D\uDCD6 Applied enchantment <fcolor:2><argument:0><fcolor:1> to <fcolor:2><argument:1><fcolor:1> entities");
                put("commands.enchant.success.single", "<fcolor:1>\uD83D\uDCD6 Applied enchantment <fcolor:2><argument:0><fcolor:1> to <argument:1>'s item");
                put("commands.enchant.success", "<fcolor:1>\uD83D\uDCD6 Applied enchantment");
                put("commands.execute.conditional.pass", "<fcolor:1>⚡ Test passed");
                put("commands.execute.conditional.pass_count", "<fcolor:1>⚡ Test passed, count: <fcolor:2><argument:0>");
                put("commands.experience.query.levels", "<fcolor:1>⏺ <argument:0> has <fcolor:2><argument:1> <fcolor:1>experience levels");
                put("commands.experience.query.points", "<fcolor:1>⏺ <argument:0> has <fcolor:2><argument:1> <fcolor:1>experience points");
                put("commands.experience.add.levels.success.multiple", "<fcolor:1>⏺ Gave <fcolor:2><argument:0> <fcolor:1>experience levels to <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.experience.add.points.success.multiple", "<fcolor:1>⏺ Gave <fcolor:2><argument:0> <fcolor:1>experience points to <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.experience.set.levels.success.multiple", "<fcolor:1>⏺ Set <fcolor:2><argument:0> <fcolor:1>experience levels to <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.experience.set.points.success.multiple", "<fcolor:1>⏺ Set <fcolor:2><argument:0> <fcolor:1>experience points to <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.experience.add.levels.success.single", "<fcolor:1>⏺ Gave <fcolor:2><argument:0> <fcolor:1>experience levels to <argument:1>");
                put("commands.experience.add.points.success.single", "<fcolor:1>⏺ Gave <fcolor:2><argument:0> <fcolor:1>experience points to <argument:1>");
                put("commands.experience.set.levels.success.single", "<fcolor:1>⏺ Set <fcolor:2><argument:0> <fcolor:1>experience levels to <argument:1>");
                put("commands.experience.set.points.success.single", "<fcolor:1>⏺ Set <fcolor:2><argument:0> <fcolor:1>experience points to <argument:1>");
                put("commands.xp.success", "<fcolor:1>⏺ Gave <fcolor:2><argument:0> <fcolor:1>experience points to <argument:1>");
                put("commands.xp.success.levels", "<fcolor:1>⏺ Gave <fcolor:2><argument:0> <fcolor:1>experience levels to <argument:1>");
                put("commands.xp.success.negative.levels", "<fcolor:1>⏺ Taken <fcolor:2><argument:0> <fcolor:1>levels from <argument:1>");
                put("commands.fill.success", "<fcolor:1>⏹ Successfully filled <fcolor:2><argument:0> <fcolor:1>block(s)");
                put("commands.fillbiome.success", "<fcolor:1>⏹ Biomes set between <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2> <fcolor:1>and <fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>, <fcolor:2><argument:5>");
                put("commands.fillbiome.success.count", "<fcolor:1>⏹ <fcolor:2><argument:0> <fcolor:1>biome entry/entries set between <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>, <fcolor:2><argument:3> <fcolor:1>and <fcolor:2><argument:4><fcolor:1>, <fcolor:2><argument:5><fcolor:1>, <fcolor:2><argument:6>");
                put("gameMode.changed", "<fcolor:1>\uD83D\uDDD8 Your game mode has been updated to <fcolor:2><argument:0>");
                put("commands.gamemode.success.other", "<fcolor:1>\uD83D\uDDD8 Set <argument:0>'s game mode to <fcolor:2><argument:1>");
                put("commands.gamemode.success.self", "<fcolor:1>\uD83D\uDDD8 Set own game mode to <fcolor:2><argument:0>");
                put("commands.defaultgamemode.success", "<fcolor:1>\uD83D\uDDD8 The default game mode is now <fcolor:2><argument:0>");
                put("commands.gamerule.query", "<fcolor:1>\uD83D\uDDD0 Gamerule <fcolor:2><argument:0> <fcolor:1>is currently set to: <fcolor:2><argument:1>");
                put("commands.gamerule.set", "<fcolor:1>\uD83D\uDDD0 Gamerule <fcolor:2><argument:0> <fcolor:1>is now set to: <fcolor:2><argument:1>");
                put("commands.gamerule.success", "<fcolor:1>\uD83D\uDDD0 Game rule has been updated");
                put("commands.give.success.multiple", "<fcolor:1>⛏ Gave <fcolor:2><argument:0> <fcolor:2><argument:1><fcolor:1> to <argument:2> players");
                put("commands.give.success.single", "<fcolor:1>⛏ Gave <fcolor:2><argument:0> <fcolor:2><argument:1><fcolor:1> to <argument:2>");
                put("commands.give.success", "<fcolor:1>⛏ Gave <fcolor:2><argument:0><fcolor:1> * <fcolor:2><argument:1><fcolor:1> to <argument:2>");
                ...
                put("commands.locate.success", "<fcolor:1>\uD83D\uDDFA The nearest <fcolor:2><argument:0><fcolor:1> is at <fcolor:2><argument:1><fcolor:1> (<fcolor:2><argument:2> <fcolor:1>blocks away)");
                put("commands.locatebiome.success", "<fcolor:1>\uD83D\uDDFA The nearest <fcolor:2><argument:0><fcolor:1> is at <fcolor:2><argument:1><fcolor:1> (<fcolor:2><argument:2> <fcolor:1>blocks away)");
                put("commands.op.success", "<fcolor:1>\uD83E\uDD16 Made <argument:0> a server operator");
                put("commands.particle.success", "<fcolor:1>❄ Displaying particle <fcolor:2><argument:0>");
                put("commands.recipe.give.success.multiple", "<fcolor:1>\uD83D\uDCA1 Unlocked <fcolor:2><argument:0> <fcolor:1>recipe(s) for <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.recipe.give.success.single", "<fcolor:1>\uD83D\uDCA1 Unlocked <fcolor:2><argument:0> <fcolor:1>recipe(s) for <argument:1>");
                put("commands.recipe.take.success.multiple", "<fcolor:1>\uD83D\uDCA1 Took <fcolor:2><argument:0> <fcolor:1>recipe(s) from <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.recipe.take.success.single", "<fcolor:1>\uD83D\uDCA1 Took <fcolor:2><argument:0> <fcolor:1>recipe(s) from <argument:1>");
                put("commands.reload.success", "<fcolor:1>\uD83D\uDEC8 Reloading!");
                put("commands.ride.dismount.success", "<fcolor:1>\uD83C\uDFC7 <argument:0> stopped riding <argument:1>");
                put("commands.ride.mount.success", "<fcolor:1>\uD83C\uDFC7 <argument:0> started riding <argument:1>");
                put("commands.rotate.success", "<fcolor:1>\uD83E\uDD38 Rotated <argument:0>");
                ...
                put("commands.seed.success", "<fcolor:1>\uD83D\uDD11 Seed: <argument:0>");
                put("commands.setblock.success.1_19_4", "<fcolor:1>⏹ Changed the block");
                put("commands.setblock.success", "<fcolor:1>⏹ Changed the block at <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>");
                put("commands.playsound.success.multiple", "<fcolor:1>\uD83D\uDD0A Played sound <fcolor:2><argument:0> <fcolor:1>to <fcolor:2><argument:1> <fcolor:1>players");
                put("commands.playsound.success.single", "<fcolor:1>\uD83D\uDD0A Played sound <fcolor:2><argument:0> <fcolor:1>to <argument:1>");
                put("commands.stopsound.success.all", "<fcolor:1>\uD83D\uDD07 Stopped all '<fcolor:2><argument:0><fcolor:1>' sounds");
                put("commands.stopsound.success.soundSource", "<fcolor:1>\uD83D\uDD07 Stopped all sounds");
                put("commands.stopsound.success.individualSound", "<fcolor:1>\uD83D\uDD07 Stopped sound '<fcolor:2><argument:0><fcolor:1>' on source '<fcolor:2><argument:1><fcolor:1>'");
                put("commands.playsound.success", "<fcolor:1>\uD83D\uDD0A Played sound <fcolor:2><argument:0> <fcolor:1>to <argument:1>");
                put("commands.stopsound.success.source.any", "<fcolor:1>\uD83D\uDD07 Stopped all '<fcolor:2><argument:0><fcolor:1>' sounds");
                put("commands.stopsound.success.source.sound",  "<fcolor:1>\uD83D\uDD07 Stopped sound '<fcolor:2><argument:0><fcolor:1>' on source '<fcolor:2><argument:1><fcolor:1>'");
                put("commands.stopsound.success.sourceless.any", "<fcolor:1>\uD83D\uDD07 Stopped all sounds");
                put("commands.stopsound.success.sourceless.sound", "<fcolor:1>\uD83D\uDD07 Stopped sound '<fcolor:2><argument:0><fcolor:1>'");
                put("commands.spawnpoint.success", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> <fcolor:1>for <argument:3>");
                put("commands.setworldspawn.success.1_16", "<fcolor:1>\uD83D\uDECC Set the world spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>");
                put("commands.setworldspawn.success.1_21_8", "<fcolor:1>\uD83D\uDECC Set the world spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>]");
                put("commands.setworldspawn.success", "<fcolor:1>\uD83D\uDECC Set the world spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] in <fcolor:2><argument:5>");
                put("commands.setworldspawn.success.new", "<fcolor:1>\uD83D\uDECC Set the world spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] in <fcolor:2><argument:5>");
                put("commands.spawnpoint.success.multiple.1_14_2", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> for <fcolor:2><argument:3><fcolor:1> players");
                put("commands.spawnpoint.success.multiple.1_21_8", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>] in <fcolor:2><argument:4> <fcolor:1>for <fcolor:2><argument:5><fcolor:1> players");
                put("commands.spawnpoint.success.multiple", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] in <fcolor:2><argument:5> <fcolor:1>for <fcolor:2><argument:6><fcolor:1> players");
                put("commands.spawnpoint.success.multiple.new", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] in <fcolor:2><argument:5> <fcolor:1>for <fcolor:2><argument:6><fcolor:1> players");
                put("commands.spawnpoint.success.single.1_14_2", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> <fcolor:1>for <argument:3>");
                put("commands.spawnpoint.success.single.1_21_8", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>] in <fcolor:2><argument:4> <fcolor:1>for <argument:5>");
                put("commands.spawnpoint.success.single", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] in <fcolor:2><argument:5> <fcolor:1>for <argument:6>");
                put("commands.spawnpoint.success.single.new", "<fcolor:1>\uD83D\uDECC Set spawn point to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1> [<fcolor:2><argument:3><fcolor:1>, <fcolor:2><argument:4><fcolor:1>] in <fcolor:2><argument:5> <fcolor:1>for <argument:6>");
                put("commands.stop.stopping", "<fcolor:1>\uD83D\uDEC8 Stopping the server");
                put("commands.stop.start", "<fcolor:1>\uD83D\uDEC8 Stopping the server");
                put("commands.summon.success", "<fcolor:1>\uD83D\uDC3A Summoned new <argument:0>");
                put("commands.teleport.success.entity.multiple", "<fcolor:1>\uD83C\uDF00 Teleported <fcolor:2><argument:0> <fcolor:1>entities to <argument:1>");
                put("commands.teleport.success.entity.single", "<fcolor:1>\uD83C\uDF00 Teleported <argument:0> to <argument:1>");
                put("commands.tp.success", "<fcolor:1>\uD83C\uDF00 Teleported <argument:0> to <argument:1>");
                put("commands.teleport.success.location.multiple", "<fcolor:1>\uD83C\uDF00 Teleported <fcolor:2><argument:0> <fcolor:1>to <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>, <fcolor:2><argument:3><fcolor:1>");
                put("commands.teleport.success.location.single",  "<fcolor:1>\uD83C\uDF00 Teleported <fcolor:2><argument:0> <fcolor:1>to <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>, <fcolor:2><argument:3><fcolor:1>");
                put("commands.tp.success.coordinates", "<fcolor:1>\uD83C\uDF00 Teleported <fcolor:2><argument:0> <fcolor:1>to <fcolor:2><argument:1><fcolor:1>, <fcolor:2><argument:2><fcolor:1>, <fcolor:2><argument:3><fcolor:1>");
                put("commands.time.query", "<fcolor:1>☽ The time is <fcolor:2><argument:0>");
                put("commands.time.set", "<fcolor:1>☽ Set the time to <fcolor:2><argument:0>");
                ...
                put("commands.worldborder.center.success", "<fcolor:1>\uD83D\uDEAB Set the center of the world border to <fcolor:2><argument:0><fcolor:1>, <fcolor:2><argument:1>");
                put("commands.worldborder.damage.amount.success", "<fcolor:1>\uD83D\uDEAB Set the world border damage to <fcolor:2><argument:0> <fcolor:1>per block each second");
                put("commands.worldborder.damage.buffer.success", "<fcolor:1>\uD83D\uDEAB Set the world border damage buffer to <fcolor:2><argument:0> <fcolor:1>block(s)");
                put("commands.worldborder.get.success", "<fcolor:1>\uD83D\uDEAB The world border is currently <fcolor:2><argument:0> <fcolor:1>block(s) wide");
                put("commands.worldborder.get", "<fcolor:1>\uD83D\uDEAB The world border is currently <fcolor:2><argument:0> <fcolor:1>block(s) wide");
                put("commands.worldborder.set.success", "<fcolor:1>\uD83D\uDEAB Set the world border to <fcolor:2><argument:0> <fcolor:1>block(s) wide");
                put("commands.worldborder.setSlowly.grow.success", "<fcolor:1>\uD83D\uDEAB Growing the world border to <fcolor:2><argument:0> <fcolor:1>blocks wide over <fcolor:2><argument:2> <fcolor:1>seconds");
                put("commands.worldborder.set.grow", "<fcolor:1>\uD83D\uDEAB Growing the world border to <fcolor:2><argument:0> <fcolor:1>blocks wide over <fcolor:2><argument:1> <fcolor:1>seconds");
                put("commands.worldborder.set.immediate", "<fcolor:1>\uD83D\uDEAB Set the world border to <fcolor:2><argument:0> <fcolor:1>block(s) wide");
                put("commands.worldborder.setSlowly.shrink.success", "<fcolor:1>\uD83D\uDEAB Shrinking the world border to <fcolor:2><argument:0> <fcolor:1>block(s) wide over <fcolor:2><argument:2> <fcolor:1>second(s)");
                put("commands.worldborder.set.shrink", "<fcolor:1>\uD83D\uDEAB Shrinking the world border to <fcolor:2><argument:0> <fcolor:1>block(s) wide over <fcolor:2><argument:1> <fcolor:1>second(s)");
                put("commands.worldborder.warning.distance.success","<fcolor:1>\uD83D\uDEAB Set the world border warning distance to <fcolor:2><argument:0> <fcolor:1>block(s)");
                put("commands.worldborder.warning.time.success", "<fcolor:1>\uD83D\uDEAB Set the world border warning time to <fcolor:2><argument:0> <fcolor:1>second(s)");
                put("death.attack.anvil", "<fcolor:1>☠ <argument:0> was squashed by a falling anvil");
                put("death.attack.anvil.player", "<fcolor:1>☠ <argument:0> was squashed by a falling anvil while fighting <argument:1>");
                put("death.attack.arrow", "<fcolor:1>☠ <argument:0> was shot by <argument:1>");
                put("death.attack.arrow.item", "<fcolor:1>☠ <argument:0> was shot by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.badRespawnPoint.message", "<fcolor:1>☠ <argument:0> was killed by <fcolor:2>[<click:open_url:\"https://www.youtube.com/watch?v=dQw4w9WgXcQ\"><hover:show_text:\"<fcolor:2>MCPE-28723\">Intentional Game Design</hover></click>]");
                put("death.attack.cactus", "<fcolor:1>☠ <argument:0> was pricked to death");
                put("death.attack.cactus.player", "<fcolor:1>☠ <argument:0> walked into a cactus while trying to escape <argument:1>");
                put("death.attack.cramming", "<fcolor:1>☠ <argument:0> was squished too much");
                put("death.attack.cramming.player", "<fcolor:1>☠ <argument:0> was squashed by <argument:1>");
                put("death.attack.dragonBreath", "<fcolor:1>☠ <argument:0> was roasted in dragon's breath");
                put("death.attack.dragonBreath.player", "<fcolor:1>☠ <argument:0> was roasted in dragon's breath by <argument:1>");
                put("death.attack.drown", "<fcolor:1>☠ <argument:0> drowned");
                put("death.attack.drown.player", "<fcolor:1>☠ <argument:0> drowned while trying to escape <argument:1>");
                put("death.attack.dryout", "<fcolor:1>☠ <argument:0> died from dehydration");
                put("death.attack.dryout.player", "<fcolor:1>☠ <argument:0> died from dehydration while trying to escape <argument:1>");
                put("death.attack.even_more_magic", "<fcolor:1>☠ <argument:0> was killed by even more magic");
                put("death.attack.explosion", "<fcolor:1>☠ <argument:0> blew up");
                put("death.attack.explosion.player", "<fcolor:1>☠ <argument:0> was blown up by <argument:1>");
                put("death.attack.explosion.item", "<fcolor:1>☠ <argument:0> was blown up by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.explosion.player.item", "<fcolor:1>☠ <argument:0> was blown up by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.fall", "<fcolor:1>☠ <argument:0> hit the ground too hard");
                put("death.attack.fall.player", "<fcolor:1>☠ <argument:0> hit the ground too hard while trying to escape <argument:1>");
                put("death.attack.fallingBlock", "<fcolor:1>☠ <argument:0> was squashed by a falling block");
                put("death.attack.fallingBlock.player", "<fcolor:1>☠ <argument:0> was squashed by a falling block while fighting <argument:1>");
                put("death.attack.fallingStalactite", "<fcolor:1>☠ <argument:0> was skewered by a falling stalactite");
                put("death.attack.fallingStalactite.player", "<fcolor:1>☠ <argument:0> was skewered by a falling stalactite while fighting <argument:1>");
                put("death.attack.fireball", "<fcolor:1>☠ <argument:0> was fireballed by <argument:1>");
                put("death.attack.fireball.item", "<fcolor:1>☠ <argument:0> was fireballed by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.fireworks", "<fcolor:1>☠ <argument:0> went off with a bang");
                put("death.attack.fireworks.item", "<fcolor:1>☠ <argument:0> went off with a bang due to a firework fired from <fcolor:2><argument:2><fcolor:1> by <argument:1>");
                put("death.attack.fireworks.player", "<fcolor:1>☠ <argument:0> went off with a bang while fighting <argument:1>");
                put("death.attack.flyIntoWall", "<fcolor:1>☠ <argument:0> experienced kinetic energy");
                put("death.attack.flyIntoWall.player", "<fcolor:1>☠ <argument:0> experienced kinetic energy while trying to escape <argument:1>");
                put("death.attack.freeze", "<fcolor:1>☠ <argument:0> froze to death");
                put("death.attack.freeze.player", "<fcolor:1>☠ <argument:0> was frozen to death by <argument:1>");
                put("death.attack.generic", "<fcolor:1>☠ <argument:0> died");
                put("death.attack.generic.player", "<fcolor:1>☠ <argument:0> died because of <argument:1>");
                put("death.attack.genericKill", "<fcolor:1>☠ <argument:0> was killed");
                put("death.attack.genericKill.player", "<fcolor:1>☠ <argument:0> was killed while fighting <argument:1>");
                put("death.attack.hotFloor", "<fcolor:1>☠ <argument:0> discovered the floor was lava");
                put("death.attack.hotFloor.player", "<fcolor:1>☠ <argument:0> walked into the danger zone due to <argument:1>");
                put("death.attack.indirectMagic", "<fcolor:1>☠ <argument:0> was killed by <argument:1> using magic");
                put("death.attack.indirectMagic.item", "<fcolor:1>☠ <argument:0> was killed by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.inFire", "<fcolor:1>☠ <argument:0> went up in flames");
                put("death.attack.inFire.player", "<fcolor:1>☠ <argument:0> walked into fire while fighting <argument:1>");
                put("death.attack.inWall", "<fcolor:1>☠ <argument:0> suffocated in a wall");
                put("death.attack.inWall.player", "<fcolor:1>☠ <argument:0> suffocated in a wall while fighting <argument:1>");
                put("death.attack.lava", "<fcolor:1>☠ <argument:0> tried to swim in lava");
                put("death.attack.lava.player", "<fcolor:1>☠ <argument:0> tried to swim in lava to escape <argument:1>");
                put("death.attack.lightningBolt", "<fcolor:1>☠ <argument:0> was struck by lightning");
                put("death.attack.lightningBolt.player", "<fcolor:1>☠ <argument:0> was struck by lightning while fighting <argument:1>");
                put("death.attack.mace_smash", "<fcolor:1>☠ <argument:0> was smashed by <argument:1>");
                put("death.attack.mace_smash.item", "<fcolor:1>☠ <argument:0> was smashed by <argument:1> with <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.magic", "<fcolor:1>☠ <argument:0> was killed by magic");
                put("death.attack.magic.player", "<fcolor:1>☠ <argument:0> was killed by magic while trying to escape <argument:1>");
                put("death.attack.mob", "<fcolor:1>☠ <argument:0> was slain by <argument:1>");
                put("death.attack.mob.item", "<fcolor:1>☠ <argument:0> was slain by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.onFire", "<fcolor:1>☠ <argument:0> burned to death");
                put("death.attack.onFire.item", "<fcolor:1>☠ <argument:0> was burned to a crisp while fighting <argument:1> wielding <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.onFire.player", "<fcolor:1>☠ <argument:0> was burned to a crisp while fighting <argument:1>");
                put("death.attack.outOfWorld", "<fcolor:1>☠ <argument:0> fell out of the world");
                put("death.attack.outOfWorld.player", "<fcolor:1>☠ <argument:0> didn't want to live in the same world as <argument:1>");
                put("death.attack.outsideBorder", "<fcolor:1>☠ <argument:0> left the confines of this world");
                put("death.attack.outsideBorder.player", "<fcolor:1>☠ <argument:0> left the confines of this world while fighting <argument:1>");
                put("death.attack.player", "<fcolor:1>☠ <argument:0> was slain by <argument:1>");
                put("death.attack.player.item", "<fcolor:1>☠ <argument:0> was slain by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                ...
                put("death.attack.starve.player", "<fcolor:1>☠ <argument:0> starved to death while fighting <argument:1>");
                put("death.attack.sting", "<fcolor:1>☠ <argument:0> was stung to death");
                put("death.attack.sting.item", "<fcolor:1>☠ <argument:0> was stung to death by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.sting.player", "<fcolor:1>☠ <argument:0> was stung to death by <argument:1>");
                put("death.attack.sweetBerryBush", "<fcolor:1>☠ <argument:0> was poked to death by a sweet berry bush");
                put("death.attack.sweetBerryBush.player", "<fcolor:1>☠ <argument:0> was poked to death by a sweet berry bush while trying to escape <argument:1>");
                put("death.attack.thorns", "<fcolor:1>☠ <argument:0> was killed while trying to hurt <argument:1>");
                put("death.attack.thorns.item", "<fcolor:1>☠ <argument:0> was killed by <fcolor:2><argument:2><fcolor:1> while trying to hurt <argument:1>");
                put("death.attack.thrown", "<fcolor:1>☠ <argument:0> was pummeled by <argument:1>");
                put("death.attack.thrown.item", "<fcolor:1>☠ <argument:0> was pummeled by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.trident", "<fcolor:1>☠ <argument:0> was impaled by <argument:1>");
                put("death.attack.trident.item", "<fcolor:1>☠ <argument:0> was impaled by <argument:1> with <fcolor:2><argument:2><fcolor:1>");
                put("death.attack.wither", "<fcolor:1>☠ <argument:0> withered away");
                put("death.attack.wither.player", "<fcolor:1>☠ <argument:0> withered away while fighting <argument:1>");
                put("death.attack.witherSkull", "<fcolor:1>☠ <argument:0> was shot by a skull from <argument:1>");
                put("death.attack.witherSkull.item", "<fcolor:1>☠ <argument:0> was shot by a skull from <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.fell.accident.generic", "<fcolor:1>☠ <argument:0> fell from a high place");
                put("death.fell.accident.ladder", "<fcolor:1>☠ <argument:0> fell off a ladder");
                put("death.fell.accident.other_climbable", "<fcolor:1>☠ <argument:0> fell while climbing");
                put("death.fell.accident.scaffolding", "<fcolor:1>☠ <argument:0> fell off scaffolding");
                put("death.fell.accident.twisting_vines", "<fcolor:1>☠ <argument:0> fell off some twisting vines");
                put("death.fell.accident.vines", "<fcolor:1>☠ <argument:0> fell off some vines");
                put("death.fell.accident.weeping_vines", "<fcolor:1>☠ <argument:0> fell off some weeping vines");
                put("death.fell.assist", "<fcolor:1>☠ <argument:0> was doomed to fall by <argument:1>");
                put("death.fell.assist.item", "<fcolor:1>☠ <argument:0> was doomed to fall by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.fell.finish", "<fcolor:1>☠ <argument:0> fell too far and was finished by <argument:1>");
                put("death.fell.finish.item", "<fcolor:1>☠ <argument:0> fell too far and was finished by <argument:1> using <fcolor:2><argument:2><fcolor:1>");
                put("death.fell.killer", "<fcolor:1>☠ <argument:0> was doomed to fall");
            }
        };
    }
}
