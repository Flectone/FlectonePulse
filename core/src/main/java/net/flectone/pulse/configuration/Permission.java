...
public final class Permission extends FileSerializable implements ModuleConfig {
    ...
    public static final class Message implements MessageConfig, IPermission {
        ...
        public static final class Afk implements SubMessageConfig, IPermission {
            ...
            private net.flectone.pulse.configuration.Permission.Type type = net.flectone.pulse.configuration.Permission.Type.TRUE;
        }
        ...
        public static final class Chat implements SubMessageConfig, IPermission {
            ...
            private Map<String, Type> types = new LinkedHashMap<>(){
                {
                    put("local", new Type("flectonepulse.module.message.chat.local", net.flectone.pulse.configuration.Permission.Type.TRUE,
                            new PermissionEntry("flectonepulse.module.message.chat.local.cooldown.bypass", net.flectone.pulse.configuration.Permission.Type.OP),
                            new PermissionEntry("flectonepulse.module.message.chat.local.sound", net.flectone.pulse.configuration.Permission.Type.TRUE)
                    ));
                    put("global", new Type("flectonepulse.module.message.chat.global", net.flectone.pulse.configuration.Permission.Type.TRUE,
                            new PermissionEntry("flectonepulse.module.message.chat.global.cooldown.bypass", net.flectone.pulse.configuration.Permission.Type.OP),
                            new PermissionEntry("flectonepulse.module.message.chat.global.sound", net.flectone.pulse.configuration.Permission.Type.TRUE)
                    ));
                }
            };
            ...
            public static final class Type implements IPermission {
                private String name = "flectonepulse.module.message.chat";
                private net.flectone.pulse.configuration.Permission.Type type = net.flectone.pulse.configuration.Permission.Type.TRUE;
                private PermissionEntry cooldownBypass = new PermissionEntry("flectonepulse.module.message.chat.cooldown.bypass", net.flectone.pulse.configuration.Permission.Type.OP);
                private PermissionEntry sound = new PermissionEntry("flectonepulse.module.message.chat.sound", net.flectone.pulse.configuration.Permission.Type.TRUE);
            }
        }
