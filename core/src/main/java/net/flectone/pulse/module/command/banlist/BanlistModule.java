...
public class BanlistModule extends AbstractModuleCommand<Localization.Command.Banlist> {
    ...
    public void execute(FPlayer fPlayer, CommandContext<FPlayer> commandContext) {
        ...
        for (Moderation moderation : finalModerationList) {
            ...
            String line = Strings.CS.replace(localizationType.getLine(), "<command>", "/" + unbanModule.getCommandName() + " <player> <id>");
        ...
        eventDispatcher.dispatch(new SenderToReceiverMessageEvent(fPlayer, component, new EmptyMessageMetadata(MessageType.COMMAND_BANLIST)));
