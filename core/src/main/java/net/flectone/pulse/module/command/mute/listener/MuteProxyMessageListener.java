...
public class MuteProxyMessageListener implements PulseListener {
    ...
    public Event onProxyMessageEvent(ProxyMessageEvent event) throws IOException {
        ...
        try (ProxyPayload proxyPayload = event.openPayload()) {
            ...
            messageDispatcher.dispatch(muteModule, EventMetadata.builder()
                    ...
                    .messageContext(fResolver -> ModerationMessageContext.builder()
                            .base(MessageContext.builder()
                                    ...
                                    .sender(event.sender())
                                    .receiver(fResolver)
                                    .message(moderationMessageFormatter.replacePlaceholders(muteModule.localization(fResolver).server(), fResolver, mute))
            ...
            muteModule.sendForTarget(fModerator, (FPlayer) event.sender(), mute);
        }
