...
public class AnonModule implements ModuleCommand<Localization.Command.Anon> {
    ...
    public void onEnable() {
        ...
        if (proxyRegistry.hasEnabledProxy()) {
            listenerRegistry.register(AnonProxyMessageListener.class);
        }
    }
    ...
    public void execute(FPlayer fPlayer, CommandContext<FPlayer> commandContext) {
        ...
        messageDispatcher.dispatch(this, EventMetadata.<Localization.Command.Anon>builder()
                .sender(fPlayer)
    ...
    @Override
    public Localization.Command.Anon localization(FPlayer fPlayer) {
        return fileFacade.localization(socialService.getSetting(fPlayer, SettingText.LOCALE)).command().anon();
    }
}
